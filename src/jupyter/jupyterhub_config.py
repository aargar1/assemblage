...
#  Default: '/srv/jupyterhub/share/jupyterhub'
# c.JupyterHub.data_files_path = '/srv/jupyterhub/share/jupyterhub'
...
#  Default: []
c.JupyterHub.template_paths = ['/srv/jupyterhub/etc/jupyterhub/templates']
